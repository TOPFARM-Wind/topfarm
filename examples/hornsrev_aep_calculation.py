...
x = np.array([426487.])  # east-west location(s) of resource (Horns Rev WT 47)
y = np.array([6149224.])  # north-south location(s) of resource
...
wfl_path = '../topfarm/tests/data/hornsrev.yml'  # path to YAML file
